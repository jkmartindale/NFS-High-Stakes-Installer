(* Modified from code in Lego Racers Alternate Installer by Triangle717
...
const
    UniqueFile = 'NFSHS.ICO';
    CDName = 'Need for Speed: High Stakes';
...
begin
	...
	begin
		...
		begin
			if MsgBox('Is there a ' + CDName + ' CD in your computer? If not, please insert it and press OK.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
